...
class TextStyles {
  ...
  static final titleCategoryCard = GoogleFonts.roboto(
    fontSize: 14,
    fontWeight: FontWeight.w500,
    color: AppColors.cardCategory,
  );

  static final titleCardPrimary = GoogleFonts.roboto(
    fontSize: 14,
    fontWeight: FontWeight.w700,
    color: AppColors.cardTitle,
  );

  static final titleCardSecundary = GoogleFonts.roboto(
    fontSize: 14,
    fontWeight: FontWeight.w500,
    color: AppColors.cardTitle,
  );
  ...
  static final textAppBarNS = GoogleFonts.roboto(
    fontSize: 12,
    fontWeight: FontWeight.w400,
